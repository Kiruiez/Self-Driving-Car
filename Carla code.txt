...
from keras.layers import Dense, GlobalAveragePooling2D, Dropout, Conv2D, MaxPooling2D, Activation, Flatten, AveragePooling2D 
...
try:
    sys.path.append('../carla/dist/carla-0.9.10-py3.7-win-amd64.egg')
except IndexError:
    pass
import carla
...
class ModifiedTensorBoard(TensorBoard):
    ...
    def set_model(self, model):
        ...
        self.should_write_train_graph = False
...
class DQNAgent:
    ...
    def create_model(self):
        #base_model = self.model_base_test_CNN()
